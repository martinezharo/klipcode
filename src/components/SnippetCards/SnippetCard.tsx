        ...
        <div className="flex min-w-0 flex-1 items-center gap-2">
          ...
          {isRenaming ? (
            <input
              ...
              className="klipcode-editable-focus min-w-0 flex-1 select-text rounded bg-ink/[0.07] px-2 py-0.5 text-sm font-medium text-foreground outline-none ring-1 ring-ink/15 transition-shadow focus:ring-ink/45"
            />
          ) : (
            <button
              type="button"
